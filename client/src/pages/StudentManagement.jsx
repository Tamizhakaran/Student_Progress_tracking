                        ...
                        <div className="pt-24 pb-12 px-12">
                            <div className="flex justify-between items-start mb-10">
                                <div>
                                    ...
                                    <div className="mt-4 flex flex-col gap-2">
                                        ...
                                        <label
                                            ...
                                            className="px-4 py-2 rounded-xl bg-slate-50 border border-slate-100 text-[10px] font-black uppercase tracking-widest cursor-pointer hover:bg-slate-100 transition-all inline-flex items-center gap-2 w-fit"
                                        >
                                            <FiPlus /> Change Profile Image
                                        </label>
                                    </div>
                                </div>
                                <div className="flex flex-col items-end gap-2">
                                    ...
                                    <div className="px-4 py-2 rounded-2xl bg-indigo-50 text-indigo-600 text-[10px] font-black uppercase tracking-widest border border-indigo-100">
